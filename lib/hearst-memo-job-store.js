...
// Mirrors the real 2-model chain in lib/llm/kimi.ts (KIMI_FALLBACK_CHAIN).
// glm-5 and minimax-m2.5 were removed from the server chain — keep this in sync.
const CASCADE = ['kimi-k2.6', 'kimi-k2.5'];
