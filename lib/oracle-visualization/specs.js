...
// ---------------------------------------------------------------------------
// Palette aligned with hearst.module.css --ct-* (hex for API/LLM payloads)
// ---------------------------------------------------------------------------
const KIND_COLOR = {
  classic: '#A3FF8D', // --ct-accent
  liquid:  '#151515', // --ct-surface-elevated
  ai:      '#7AB8FF', // --ct-compute
  air:     '#121212', // --ct-surface
  hybrid:  '#2A2A2A', // --ct-border
};
