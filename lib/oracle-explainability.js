...
const METRICS = {
  ...
  IRR: {
    ...
    minister: {
      ...
      body: 'IRR expresses, as a single percentage, the efficiency of public and private capital over the project lifecycle. A government co-investment at 14% IRR outperforms most infrastructure bonds and many national public-works projects. It enables apples-to-apples comparison across the national development plan.',
  ...
  MOIC: {
    ...
    minister: {
      ...
      body: 'For a government co-investment of QAR 500M, a 2.5× MOIC returns QAR 1.25B over the project life — gross. This metric communicates economic return to non-financial stakeholders clearly and without ambiguity.',
  ...
  DSCR: {
    ...
    minister: {
      ...
      body: 'A DSCR above 1.3× confirms the infrastructure generates sufficient cash to service its debt without requiring government intervention. This de-risks government guarantee exposure and confirms the investment is commercially viable on its own terms.',
  ...
  payback: {
    ...
    operator: {
      ...
      body: 'Calculate payback separately for each revenue stream (colocation, cloud, managed services, government). If payback on GPU-heavy revenue exceeds GPU depreciation cycle (5–7 years), re-model with hardware refresh capex included — this is a common modelling oversight that understates true payback.',
  ...
  EBITDA_margin: {
    ...
    minister: {
      ...
      body: "An EBITDA margin of 55% on Qatar's national AI infrastructure means QAR 550M of every QAR 1B in annual revenue is retained as operational surplus — available for debt service, national reinvestment, or dividend to the government fund.",
  ...
  CAPEX_per_MW: {
    ...
    minister: {
      ...
      body: "A CAPEX/MW of $9M means Qatar pays QAR 32M for each megawatt of government AI capacity. At 100MW, that is QAR 3.2B total — comparable to a mid-size infrastructure project. Comparing this figure to international benchmarks confirms whether Qatar's procurement is competitive.",
  ...
  exit_multiple: {
    ...
    minister: {
      ...
      body: "A government fund retaining a 30% stake in a 100MW AI campus generating $100M EBITDA at a 25× exit multiple holds an asset worth $750M — 2.5× the QAR 1B initial investment. Exit multiples in AI infrastructure are structurally elevated due to structural hyperscale demand growth.",
      why_it_matters: "Demonstrates that early-stage national investment in AI infrastructure creates long-term balance sheet wealth for the government fund — not merely annual cash flow. Critical for Qatar's intergenerational wealth transfer narrative.",
    },
    operator: {
  ...
  occupancy_ramp: {
    ...
    minister: {
      ...
      body: "A phased 100MW national AI campus reaching 90% occupancy by year 3 means 90MW of AI computing capacity is generating economic activity — training models, running cloud services, hosting government workloads — within Qatar's digital economy.",
      why_it_matters: 'Occupancy ramp translates from infrastructure investment to active digital economy participation. Faster ramp requires pre-commitment from anchor tenants — a policy lever available through government-directed procurement and government workload prioritization.',
    },
    operator: {
  ...
  utilization: {
    ...
    minister: {
      ...
      body: "An 80% utilization rate on Qatar's national AI infrastructure means 80% of computing capacity is actively processing AI workloads — training government models, running public sector AI services, hosting commercial tenants — rather than sitting idle.",
  ...
  tier_iv: {
    beginner: {
      ...
      why_it_matters: 'Tier IV is required for the most critical applications: national security systems, defense AI, financial trading, and government government AI where even minutes of downtime are unacceptable.',
    },
    investor: {
      short: 'Fault tolerant; 99.9995% uptime; 2N+1 redundancy; dual active power and cooling paths',
      body: 'Tier IV: 2N or 2N+1 redundancy on every system, two simultaneous active power and cooling paths carrying full load. Maximum 26 minutes downtime per year. Capex premium vs. Tier III: 25–40%. Warranted for government, defense, and financial workloads — avoid over-specifying for standard commercial AI.',
    ...
    minister: {
      short: 'Highest international standard — zero planned or unplanned downtime for government systems',
      body: "Tier IV means Qatar's government AI infrastructure continues operating through any single failure — power outage, equipment fault, maintenance. It is the appropriate standard for defense AI workloads, classified government data, and mission-critical national digital services.",
      why_it_matters: "Selecting Tier IV for government AI systems is a national security decision — it ensures continuity of critical government AI operations under any circumstances, including infrastructure emergencies.",
    },
    operator: {
  ...
  redundancy: {
    ...
    minister: {
      ...
      body: "National AI infrastructure must have redundant systems for power, cooling, and connectivity. This means if any single component fails — a transformer, a chiller, a network router — operations continue uninterrupted, protecting government data, public services, and commercial tenants simultaneously.",
      why_it_matters: "Redundancy is the engineering foundation of digital independence — ensuring Qatar's critical digital services cannot be interrupted by single points of failure in any part of the infrastructure.",
    },
    operator: {
  ...
  air_cooling: {
    ...
    minister: {
      ...
      body: "Legacy datacenters globally use air cooling — it is proven and widely understood. However, for the AI chips needed to attract hyperscale tenants and host government AI workloads, air cooling alone is insufficient. Modern AI campuses must be designed for liquid cooling from day one.",
  ...
  BTS: {
    ...
    minister: {
      short: 'Purpose-built national AI infrastructure incorporating government specifications from day one',
      body: "A BTS agreement with a hyperscaler means Qatar defines the specifications — power density, redundancy, security requirements, data independence zones, Qatari staffing requirements — and the partner builds accordingly. Qatar gets exactly the AI infrastructure it needs, not a generic commercial product.",
      why_it_matters: "BTS is the mechanism through which Qatar can embed independence requirements into hyperscale infrastructure from the design stage — data localization, security clearances, Qatari employment minimums — not as afterthoughts.",
    },
    operator: {
  ...
  hyperscale_lease: {
    ...
    minister: {
      ...
      why_it_matters: "One hyperscale anchor lease catalyzes the entire digital economy: it attracts secondary tenants, validates the facility for government workloads, generates tax revenue, and places Qatar on the global technology map.",
    },
    operator: {
  ...
  GPU_hour_price: {
    ...
    minister: {
      short: "Qatar's competitive price for government AI computing capacity",
      ...
      why_it_matters: "Commercially pricing government AI computing creates national digital revenue while reducing GCC dependence on foreign cloud providers — a strategic advantage for Qatar's regional digital leadership aspirations.",
    },
    operator: {
  ...
  allocation_risk: {
    ...
    minister: {
      ...
      body: "NVIDIA's AI chips — the hardware that powers global AI — are severely supply-constrained globally. Qatar must secure hardware allocation through direct government-to-company partnerships or strategic government agreements with NVIDIA to guarantee timely delivery for national AI infrastructure.",
  ...
  sovereign_cloud: {
    beginner: {
      ...
      body: "A government cloud means a country's data stays inside its borders, under its own laws, controlled by its own government. Unlike renting computing power from Amazon AWS (a US company), government cloud means Qatar owns and operates the infrastructure. No foreign company or government has access.",
      why_it_matters: "National security, government data privacy, and digital independence all depend on government cloud. Countries without it rely entirely on foreign companies for critical digital infrastructure — a significant strategic vulnerability.",
    },
    investor: {
      short: 'Government-controlled cloud infrastructure; 20–40% revenue premium from public sector tenants',
      body: 'Government cloud: cloud infrastructure physically in country, operated under national law, with contractual data independence guarantees. Revenue premium: government workloads pay 20–40% above commercial rates. Anchor tenant model: national government as anchor, GCC public sector as secondary market. Long-term contracts (5–15 years) with inflation escalators.',
      why_it_matters: 'Government cloud positioning unlocks public sector procurement budgets — guaranteed long-term contracts, non-price-sensitive buyers — inaccessible to foreign hyperscalers. Durable structural competitive advantage in the GCC market.',
    },
    minister: {
      short: "Qatar's independent, nationally controlled digital infrastructure — independence in practice",
      body: "Government cloud ensures that Qatar's government data — citizen records, defense systems, economic databases, AI model outputs — is stored and processed under Qatari law, on Qatari infrastructure, accessible only to Qatari-authorized personnel. Digital independence is as real as territorial independence.",
      why_it_matters: "Qatar's Vision 2030 digital transformation, government AI services, and national security systems cannot be built on infrastructure controlled by foreign governments or foreign companies. Government cloud is the prerequisite for digital national independence.",
    },
    operator: {
      short: 'Physical isolation; Qatari citizen-only staff for classified zones; HSM under national key authority; NIAS compliant',
      body: 'Government cloud technical requirements: physical isolation (dedicated halls or cages), Qatari-citizen-only operations staff for classified zones, encryption key management under national authority (on-site HSM), network isolation (no cross-border routing), and compliance with Qatar National Information Assurance Standard (NIAS). Annual government audit.',
      why_it_matters: 'Non-compliance with government cloud requirements triggers immediate contract termination and potential national security review. Government zone operations must be under a cleared Security Officer authority from day one of operations.',
    },
  },
  ...
  government_AI: {
    beginner: {
      ...
      body: "Government AI means a nation develops its own artificial intelligence models and systems — in its own language, on its own data, under its own control. Instead of relying on OpenAI or Google, Qatar would have its own AI that understands Arabic, knows Qatari and Gulf context, and is controlled entirely by Qatar.",
      why_it_matters: "AI is increasingly the technology that runs economies, governments, and militaries. A country without government AI depends on foreign AI systems that may not serve its interests, may not speak its language, and may be unavailable in a crisis.",
    },
    investor: {
      short: 'National AI capability (models + compute + talent); premium GCC public sector revenue',
      body: 'Government AI investment thesis: governments paying premium to develop national foundation models (Arabic LLMs, government-domain models), government compute infrastructure, and national AI talent pipelines. Revenue: government contracts, regional SaaS, API licensing across GCC. Growing explicit budget line in every Gulf state — QIA, PIF, Mubadala all have government AI mandates.',
      why_it_matters: 'Government AI is a structural tailwind for Gulf AI infrastructure — governments are non-price-sensitive buyers of nationally controlled AI compute and services. First-mover advantage in Qatar creates durable competitive position in the GCC government AI market.',
    },
    minister: {
      short: "Qatar's strategic AI independence — Arabic-first, nationally owned, government in every dimension",
      body: "Government AI means Qatar develops foundation AI models trained on Arabic language, Islamic context, Gulf culture, and Qatari-specific data — controlled entirely by Qatar. This cannot be outsourced to OpenAI or any foreign company. It requires national infrastructure, national data governance, national talent, and persistent national commitment.",
      why_it_matters: "Qatar's digital diplomacy, public services, defense applications, and economic competitiveness in the AI era all depend on having government AI capability. Countries that don't develop it now will be permanently dependent on foreign AI providers with no path to independence.",
    },
    operator: {
      short: 'Isolated GPU cluster; national model registry; Qatari-only access to training data; NIAS compliance',
      body: 'Government AI infrastructure: GPU cluster physically isolated from commercial zones, national model registry (versioned, auditable, immutable), training data stored in Qatar under data residency law, inference endpoints via national API gateway only. Minimum GPU footprint for foundation model training: 512–4,096 H100 equivalents.',
      why_it_matters: 'Government AI operations require strict separation of duties — infrastructure operator never has access to model weights or training data. Only compute infrastructure access is granted. This boundary must be enforced contractually and technically from day one.',
    },
  },
...
const TERMS = {
  ...
  tier_iv: {
    ...
    minister: 'Highest international standard — zero planned or unplanned downtime, required for government and defense AI.',
  ...
  sovereign_cloud: {
    ...
    minister: "National digital independence infrastructure — Qatar's data under Qatari law, operated by Qatari personnel.",
  ...
  sovereign_ai: {
    ...
    minister: "Qatar's strategic AI independence — Arabic-first foundation models under full national government control.",
  ...
  // ---------------------------------------------------------------------------
  // Sprint 3.1 — 15 new terms
  // ---------------------------------------------------------------------------
  occupancy_ramp_risk: {
    beginner: 'Revenue may grow slower than infrastructure costs during the first years.',
    investor: 'Risk that occupancy trails model — DSCR compressed below covenant in years 1–3; stress-test at 70% base case.',
    minister: 'Risk that national AI capacity sits partly idle longer than planned, delaying economic impact of the investment.',
    operator: 'Track LOI-to-signed and signed-to-energized conversion weekly; flag any slippage against financial model milestones.',
  },
  interconnection_dependency: {
    beginner: 'The project depends heavily on external network connectivity partners.',
    investor: 'Concentration risk from single-carrier connectivity; suppresses tenant SLA guarantees and compresses exit multiple.',
    minister: 'Strategic vulnerability when national AI infrastructure relies on a single connectivity partner or cross-border route.',
    operator: 'Carrier-neutral handover with dual diverse BGP paths mandatory; document per-carrier MRC, escalation SLA, and failover RTO.',
  },
  anchor_tenant: {
    beginner: 'The main long-term customer whose commitment makes the whole project financially viable.',
    investor: 'Pre-committed large tenant (20–40% capacity) that enables construction financing and de-risks occupancy ramp.',
    minister: 'Strategic long-term partner whose early commitment validates national AI infrastructure to all other investors.',
    operator: 'Anchor LOI signed before FID; dedicated relationship manager assigned; priority fit-out schedule above all others.',
  },
  powered_shell_anchor: {
    beginner: 'A big tech company that takes over a ready-built empty space and installs its own computers inside.',
    investor: 'Hyperscale-grade powered shell tenant; developer delivers power and cooling; tenant deploys proprietary IT at scale.',
    minister: "A hyperscaler committing to Qatar's AI campus on its own technical terms — the highest-value development outcome.",
    operator: 'Handover boundary at IT distribution board; tenant spec freeze at RIBA Stage 2; tenant self-performs fit-out.',
  },
  absorption_capacity: {
    beginner: 'How much new computing space the local market can actually fill each year.',
    investor: 'Annual MW a regional market can absorb without oversupply-driven yield compression; primary supply-demand gauge.',
    minister: 'Rate at which Qatar and GCC can productively deploy AI infrastructure without stranding new national investment.',
    operator: 'Track MW signed vs. MW available annually; alert when pipeline exceeds 18-month regional absorption rate.',
  },
  oversupply_risk: {
    beginner: 'Too many datacenters built in one area, pushing prices down for everyone.',
    investor: 'Market risk of excess regional supply compressing rack rates, yields, and exit multiples below underwriting assumptions.',
    minister: "Policy risk that uncoordinated private investment floods GCC market, undermining Qatar's national infrastructure economics.",
    operator: 'Monitor competitor supply pipeline quarterly; escalate if regional supply growth exceeds demand growth by 20%+.',
  },
  pricing_compression: {
    beginner: 'Prices drop because too many providers are competing for the same customers.',
    investor: 'Revenue yield erosion from competitive supply; primary threat to GPU cloud unit economics at year 3+.',
    minister: 'Commercial pressure on national AI infrastructure pricing — requires strategic positioning beyond pure price competition.',
    operator: 'Benchmark rack and GPU rates weekly vs. regional peers; escalate if spot pricing drops 15%+ quarter-on-quarter.',
  },
  customer_concentration: {
    beginner: 'Too much of your income comes from one or two customers — dangerous if they leave.',
    investor: 'Revenue risk when top 1–3 tenants represent > 50% of NOI; increases refinancing risk and suppresses exit multiple.',
    minister: 'National revenue risk from over-dependence on a single international partner for AI infrastructure income.',
    operator: 'Track top-3 tenant revenue share monthly; flag if any single tenant exceeds 35% of facility NOI.',
  },
  water_stress_premium: {
    beginner: 'Extra cost of operating in a water-scarce region — makes liquid cooling even more important.',
    investor: 'OPEX and regulatory premium in water-constrained regions; closed-loop liquid cooling eliminates most of this exposure.',
    minister: 'Policy cost of water-intensive cooling in a water-scarce country — technology mandates eliminate this dependency.',
    operator: 'Quantify water consumption per MWh of IT load; closed-loop CDU reduces consumption to near zero; report to ASHGHAL quarterly.',
  },
  substation_capacity: {
    beginner: 'The limit on how much electricity the local power station can supply to the datacenter.',
    investor: 'Available grid headroom at utility substation; primary constraint on phased campus expansion planning.',
    minister: 'National grid capacity constraint requiring early coordination with Kahramaa for large AI campus power loads.',
    operator: 'Confirm substation headroom before Phase 2 commitment; reserve capacity contractually; track headroom quarterly.',
  },
  carrier_neutral: {
    beginner: 'Any internet company can connect here — not stuck with just one provider.',
    investor: 'Facility policy enabling multiple network carriers; reduces connectivity concentration risk; improves tenant SLA quality.',
    minister: 'Open connectivity infrastructure enabling competition and redundancy — prerequisite for hyperscale tenants globally.',
    operator: 'Carrier-neutral MMR with diverse conduit entries; minimum 2 diverse fiber carriers active at handover.',
  },
  liquid_cooling_premium: {
    beginner: 'The extra upfront cost of water-based cooling — paid back quickly through lower electricity bills.',
    investor: 'Capex uplift of $25–80K per rack row for CDU/DLC vs. air cooling; payback 3–5 years from PUE savings alone.',
    minister: 'Strategic infrastructure investment in advanced cooling — delivers durable energy and competitive advantages.',
    operator: 'Track CDU capex per row vs. budget; validate payback model at each phase gate using actual PUE readings.',
  },
  nnn_lease: {
    beginner: 'A rent contract where the tenant pays all costs on top of rent — landlord just collects.',
    investor: 'Triple-net: tenant pays taxes, insurance, and maintenance; landlord receives stable, predictable net cash flow.',
    minister: 'Long-term contract structure where international companies bear all operating costs — stable government revenue.',
    operator: 'Tenant scope: all M&E maintenance, insurance, taxes; landlord scope: structural envelope only; reconcile annually.',
  },
  take_or_pay: {
    beginner: 'A contract where the customer must pay whether they use the service or not.',
    investor: 'Revenue protection clause; customer pays fixed capacity charge regardless of actual utilization — protects DSCR.',
    minister: 'Long-term revenue guarantee from anchor tenants — ensures national infrastructure generates predictable income.',
    operator: 'Include in anchor LOI; specify capacity charge, minimum utilization threshold, and cure period before default.',
  },
  export_control: {
    beginner: 'Government rules that limit which countries can buy advanced AI chips.',
    investor: 'US export regulations (EAR/BIS) restricting AI chip export to certain jurisdictions; affects hardware procurement strategy.',
    minister: 'US-origin technology controls shaping which AI hardware Qatar can procure and the conditions of national deployment.',
    operator: 'NVIDIA export compliance review at PO stage; end-use certificates documented; no re-export without US government clearance.',
  },
  BTS: {
    ...
    minister: "Purpose-built national AI infrastructure that embeds Qatar's government specifications from the design stage.",
...
export function explainRecommendation(recommendation, audience = 'beginner') {
  ...
  if (lower.includes('sovereign')) {
    return _governmentExplanation(recText, audience);
  }
...
export function simplifyTechnicalTerm(term, audience = 'beginner') {
  ...
  // Fallback to METRICS short description (try normalized first, then original key for acronyms)
  const metricEntry = METRICS[normalized] || METRICS[term] || METRICS[term.toUpperCase()];
...
function _tierUpgradeExplanation(rec, audience) {
  const explanations = {
    beginner: {
      ...
      key_tradeoff: 'Costs 25–40% more to build, but unlocks premium government and defense contracts that pay significantly more over the long term.',
      plain_action: 'Approve Tier IV for government and defense zones; use Tier III for commercial zones to control total construction cost.',
    },
    investor: {
      short_summary: 'Tier IV specification for government zones; Tier III for commercial — maximize return per capex dollar.',
      why_this_recommendation: 'Tier IV unlocks government and defense tenants (20–30% revenue premium, long WAULT) while 2N+1 redundancy maximizes exit multiple. Dual-zone design controls total MEP capex.',
      key_tradeoff: 'Tier IV MEP capex premium of 25–40% vs. Tier III; justified when government/defense revenue exceeds 30% of total income and WAULT uplift improves exit multiple materially.',
      plain_action: 'Approve dual-zone design: Tier IV government hall Phase 1, Tier III commercial halls Phases 2–3. Run IRR comparison before committing.',
    },
    minister: {
      short_summary: 'Build government AI infrastructure to the highest international standard.',
      why_this_recommendation: "Tier IV is the non-negotiable standard for national security AI, defense AI, and government data systems. Qatar's credibility as a serious AI government power requires Tier IV for all government-designated zones.",
      key_tradeoff: 'Higher construction cost for government zones — justified as a national security investment, not purely a commercial one.',
      plain_action: 'Mandate Tier IV for government and defense halls in the national AI campus — enshrine in technical specifications before tender.',
    },
    operator: {
      short_summary: 'Implement 2N+1 active-active power and cooling for government zone; Tier III for commercial.',
      why_this_recommendation: 'Tier IV is contractually required for government tenants. Government SLAs mandate fault-tolerant infrastructure — non-compliance triggers immediate contract termination.',
      ...
      plain_action: 'Design government SLD for 2N+1 active-active; engage Uptime Institute at RIBA Stage 2; Tier IV-certified commissioning manager mandatory.',
    },
  };
...
function _governmentExplanation(rec, audience) {
  const explanations = {
    beginner: {
      ...
      plain_action: "Allocate a dedicated zone in the national AI campus for government-only workloads — operated by Qatari personnel, physically separate from commercial zones.",
    },
    investor: {
      short_summary: 'Government zone with premium government contract revenue — bond-like cash flows at price premium.',
      why_this_recommendation: "Government zones generate 20–40% revenue premium over commercial rates from non-price-sensitive government buyers. Long-term government contracts with CPI escalation create highly durable cash flows.",
      key_tradeoff: 'Government zone requires higher security capex ($1–2M/MW premium) — justified by revenue premium and political protection from competitive pressure.',
      plain_action: 'Include dedicated government hall in Phase 1; structure government anchor lease with CPI escalation and 10-year minimum term.',
    },
    minister: {
      short_summary: "Establish Qatar's national AI independence infrastructure — a strategic national imperative.",
      ...
      key_tradeoff: "Requires sustained national commitment. Continued dependence on foreign cloud providers permanently constrains Qatar's digital independence — the long-term cost far exceeds the investment.",
      plain_action: "Establish a National AI Infrastructure Authority mandated to develop and operate government AI compute, cloud, and model infrastructure for Qatar.",
    },
    operator: {
      short_summary: 'Physical isolation, national key management, Qatari-only staff — all from day one of operations.',
      why_this_recommendation: 'Government cloud is operationally meaningless without genuine operational independence. Foreign staff access or offshore encryption keys defeat the entire purpose of physical presence in Qatar.',
      key_tradeoff: 'Qatari-citizen staffing requirement limits talent pool — plan an 18-month training pipeline for government operations staff before go-live.',
      plain_action: 'Design government zone with dedicated access control, separate network fabric, on-site HSM, NIAS compliance checklist — all complete before first government workload arrives.',
    },
  };
  return explanations[audience];
}
...
function _financialOptimizationExplanation(rec, audience) {
  const explanations = {
    ...
    minister: {
      ...
      key_tradeoff: 'Pursuing maximum financial return may conflict with strategic objectives (independence requirements, regional access pricing) — define the balance explicitly.',
      plain_action: 'Establish a dual-return framework: financial IRR target (≥ 15% levered) plus strategic return metrics (government AI capacity, Qatari tech employment, digital GDP contribution).',
    },
    operator: {
...
// ---------------------------------------------------------------------------
// Sprint 3.1 — NEW PUBLIC API
// ---------------------------------------------------------------------------

// Internal: risk-category descriptions by audience
const _RISK_CATEGORY_TEXT = {
  supply_chain: {
    beginner: 'Getting the equipment you need, on time',
    investor: 'Procurement and supply-chain execution risk impacting CAPEX/MW and schedule',
    minister: 'Strategic supply-chain constraint affecting national AI infrastructure delivery',
    operator: 'Lead-time and procurement risk on critical path items',
  },
  financial: {
    beginner: 'Whether the project makes enough money',
    investor: 'Return, covenant, or refinancing risk in the financial model',
    minister: 'Fiscal risk to government investment return and national balance sheet',
    operator: 'Cash flow, DSCR, or covenant breach risk requiring immediate management',
  },
  regulatory: {
    beginner: 'Government permissions and rules that the project must follow',
    investor: 'Permitting, compliance, and regulatory change risk impacting schedule and OPEX',
    minister: 'Policy and regulatory risk requiring ministerial or interagency coordination',
    operator: 'License, permit, and compliance obligation risk tracked in the project risk register',
  },
  market: {
    beginner: 'Changes in customer demand or competition',
    investor: 'Demand, pricing, and competitive market risk affecting revenue underwriting',
    minister: 'Strategic market risk — regional competition or demand shifts affecting national AI positioning',
    operator: 'Occupancy, pricing, and customer pipeline risk monitored weekly',
  },
  operational: {
    beginner: 'Problems running the facility day-to-day',
    investor: 'Operational execution risk impacting EBITDA margin and DSCR trajectory',
    minister: 'Operational performance risk affecting delivery of national digital infrastructure commitments',
    operator: 'Facility operations, SLA, and staffing risk managed in the operations run-book',
  },
  technical: {
    beginner: 'Engineering or technology challenges in building or running the datacenter',
    investor: 'Design, construction, or technology obsolescence risk impacting capex and revenue',
    minister: 'Technical infrastructure risk affecting long-term independence and capability of national AI systems',
    operator: 'MEP design, commissioning, and technology risk tracked in technical risk register',
  },
};

const _SEVERITY_QUALIFIERS = {
  beginner:  { HIGH: 'serious', MEDIUM: 'moderate', LOW: 'small' },
  investor:  { HIGH: 'material', MEDIUM: 'manageable', LOW: 'monitoring-only' },
  minister:  { HIGH: 'significant', MEDIUM: 'manageable', LOW: 'low-priority' },
  operator:  { HIGH: 'critical', MEDIUM: 'elevated', LOW: 'watch-list' },
};

/**
 * Produces a plain-language risk explanation for a specific risk object.
 * @param {{ category: string, label: string, severity: 'HIGH'|'MEDIUM'|'LOW' }} risk
 * @param {'beginner'|'investor'|'minister'|'operator'} audience
 * @returns {{ plain_summary: string, business_implication: string, what_to_watch: string }}
 */
export function explainRisk(risk, audience = 'beginner') {
  if (!SUPPORTED_AUDIENCES.includes(audience)) {
    throw new Error(`Unknown audience "${audience}". Supported: ${SUPPORTED_AUDIENCES.join(', ')}`);
  }

  const { category = 'operational', label = 'unspecified risk', severity = 'MEDIUM' } = risk;
  const catText = (_RISK_CATEGORY_TEXT[category] || _RISK_CATEGORY_TEXT.operational)[audience];
  const sevQ    = (_SEVERITY_QUALIFIERS[audience] || _SEVERITY_QUALIFIERS.beginner)[severity] || 'notable';

  const summaries = {
    beginner: `This is a ${sevQ} risk around ${catText.toLowerCase()}. The specific concern is: ${label}.`,
    investor: `${severity} severity ${category} risk — ${label}. Category context: ${catText}.`,
    minister: `A ${sevQ} ${category} risk requiring attention: ${label}. This falls under ${catText.toLowerCase()}.`,
    operator: `[${severity}] ${category.toUpperCase()} risk: "${label}". Context: ${catText}.`,
  };

  const implications = {
    beginner: severity === 'HIGH'
      ? 'If not managed, this could delay the project or reduce the money it generates.'
      : severity === 'MEDIUM'
        ? 'This needs watching — it could cause problems if it gets worse.'
        : 'A minor issue worth monitoring, but unlikely to affect the overall result.',
    investor: severity === 'HIGH'
      ? 'Material downside risk — likely to impact IRR, DSCR, or exit timing if unmitigated. Requires action plan at next investment committee.'
      : severity === 'MEDIUM'
        ? 'Manageable risk with appropriate mitigation — model sensitivity and assign owner with deadline.'
        : 'Low financial impact; include in monitoring dashboard and review quarterly.',
    minister: severity === 'HIGH'
      ? 'Significant risk to national investment return or strategic AI infrastructure timeline — requires ministerial decision or inter-agency coordination.'
      : severity === 'MEDIUM'
        ? 'Manageable with timely policy or commercial action — assign responsible ministry and track progress.'
        : 'Low-priority at ministerial level — delegate to project team with standard reporting.',
    operator: severity === 'HIGH'
      ? 'Critical — escalate to project director immediately. Assign dedicated mitigation owner with weekly reporting cadence.'
      : severity === 'MEDIUM'
        ? 'Elevated — include in weekly risk review; confirm mitigation owner, deadline, and success criteria.'
        : 'Watch-list — review monthly; no immediate action required unless trajectory worsens.',
  };

  const watches = {
    beginner: 'Ask your project team to explain what specific steps are being taken to manage this risk.',
    investor: `Track: (1) mitigation owner assigned, (2) milestone date set, (3) weekly status in risk register. Re-assess severity at each phase gate.`,
    minister: `Request a formal risk mitigation brief with responsible ministry, timeline, and escalation trigger for any ${severity === 'HIGH' ? 'worsening' : 'change'} in status.`,
    operator: `Risk register entry required: mitigation action, owner, target close date, weekly update flag. Escalate if severity increases or mitigation stalls.`,
  };

  return {
    plain_summary:       summaries[audience],
    business_implication: implications[audience],
    what_to_watch:       watches[audience],
  };
}


// ---------------------------------------------------------------------------
// JARGON DETECTION — Sprint 3.1
// ---------------------------------------------------------------------------

/**
 * Jargon lists per audience.
 * beginner list is the most comprehensive (30+ terms) — it is also used as the
 * base for investor/minister/operator with a smaller subset that remains
 * inappropriate for each audience.
 */
const _JARGON_BY_AUDIENCE = {
  beginner: [
    'DSCR', 'IRR', 'MOIC', 'NPV', 'EBITDA', 'WACC', 'LTV', 'PUE',
    'RFP', 'NNN', 'BTS', 'LOI', 'FID', 'MEP', 'SLD', 'SLA', 'WAULT',
    'CDU', 'RDHx', 'CRAC', 'CRAH', 'HSM', 'NIAS', 'BGP', 'MRC',
    'PPA', 'OPEX', 'CAPEX', 'kW', 'MW',
    'interconnection', 'fabric', 'hyperscale', 'neocloud', 'government-aligned',
    'colocation', 'BTS', 'carrier-neutral', 'annualized', 'underwriting',
    'leverage', 'arbitrage', 'amortization', 'covenant', 'concurrently maintainable',
    'fault tolerant', 'N+1', '2N', 'GB200', 'H100', 'B200', 'InfiniBand',
    'Kahramaa', 'ASHGHAL', 'RIBA', 'FAT',
  ],
  investor: [
    // Acronyms that should be spelled out even for investors in a mixed audience
    'NIAS', 'Kahramaa', 'ASHGHAL', 'RIBA',
  ],
  minister: [
    'DSCR', 'IRR', 'MOIC', 'PUE', 'CDU', 'RDHx', 'CRAC', 'CRAH',
    'SLD', 'MEP', 'BGP', 'MRC', 'FID', 'LOI', 'WAULT',
    'N+1', '2N', 'InfiniBand', 'GB200', 'H100', 'B200',
    'underwriting', 'leverage', 'colocation',
  ],
  operator: [
    // Operators know the domain; flag truly unusual or non-standard terms
    'government-aligned', 'neocloud',
  ],
};

/**
 * Detects jargon words in a text string that would confuse the given audience.
 * Used by Agent 8 (simplification audit) to catch over-technical outputs.
 * @param {string} text
 * @param {'beginner'|'investor'|'minister'|'operator'} audience
 * @returns {string[]} Array of jargon words found in the text
 */
export function detectJargon(text, audience = 'beginner') {
  if (!SUPPORTED_AUDIENCES.includes(audience)) {
    throw new Error(`Unknown audience "${audience}". Supported: ${SUPPORTED_AUDIENCES.join(', ')}`);
  }
  if (typeof text !== 'string') return [];

  const jargonList = _JARGON_BY_AUDIENCE[audience] || [];
  const found = [];

  for (const term of jargonList) {
    // Word-boundary match (case-sensitive for acronyms, case-insensitive for words)
    const isAcronym = term === term.toUpperCase() && term.length <= 6;
    const flags = isAcronym ? 'g' : 'gi';
    // Escape for regex
    const escaped = term.replace(/[.*+?^${}()|[\]\\]/g, '\\$&');
    const regex = new RegExp(`\\b${escaped}\\b`, flags);
    if (regex.test(text) && !found.includes(term)) {
      found.push(term);
    }
  }
