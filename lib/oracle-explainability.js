...
const TERMS = {
  ...
  nnn_lease: {
    ...
    minister: 'Long-term contract structure where international companies bear all operating costs — stable sovereign revenue.',
...
const _RISK_CATEGORY_TEXT = {
  ...
  financial: {
    ...
    minister: 'Fiscal risk to sovereign investment return and national balance sheet',
  ...
  technical: {
    ...
    minister: 'Technical infrastructure risk affecting long-term sovereignty and capability of national AI systems',
...
const _JARGON_BY_AUDIENCE = {
  beginner: [
    ...
    'interconnection', 'fabric', 'hyperscale', 'neocloud', 'sovereign-aligned',
