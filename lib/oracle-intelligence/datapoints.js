...
export const DATAPOINTS = [
  ...
  D('eqx_xscale_lease_term', 'equinix', 'datacenter_operator', 'global', 'product_sheet', 'tier_2', '2024-06-01', 'high', 'low', 'contract_term', 4,
    ...
    { source_name: 'Equinix xScale Program', applicability: 'Qatar sovereign deals likely 12-20 yr', caveat: 'xScale is wholesale-to-hyperscaler only' }),
  ...
  D('dlr_hyperion_jv', 'digital_realty', 'datacenter_operator', 'us', 'press_release', 'tier_3', '2025-10-01', 'high', 'low', 'partnership_structure', 5,
    ...
    { source_name: 'Meta x Blue Owl Hyperion JV announcement', applicability: 'Reference comp for sovereign + operator JV', caveat: 'Specific to anchor hyperscaler' }),
  ...
  D('khazna_microsoft_partnership', 'khazna', 'datacenter_operator', 'uae', 'partnership_announcement', 'tier_3', '2024-04-15', 'high', 'low', 'partnership_structure', 5,
    ...
    { source_name: 'G42-Microsoft April 2024 announcement', applicability: 'Reference sovereign + hyperscaler structure' }),
  ...
  // ─── G42 / NEOM / Humain / QIA / sovereign initiatives ────────────
  D('g42_microsoft_2024', 'g42', 'sovereign_regional', 'uae', 'press_release', 'tier_3', '2024-04-15', 'high', 'low', 'partnership_structure', 5,
    ...
    { source_name: 'G42-Microsoft April 2024', applicability: 'Reference sovereign + hyperscaler model' }),
  D('g42_stargate_uae', 'g42', 'sovereign_regional', 'uae', 'press_release', 'tier_3', '2025-01-15', 'medium', 'medium', 'partnership_structure', 5,
    ...
    { source_name: 'Stargate / G42 / NVIDIA / SoftBank / OpenAI', applicability: 'Reference mega-sovereign infra deal', caveat: 'Multi-year cumulative aspirational' }),
  ...
  D('humain_ksa_2024', 'humain_ksa', 'sovereign_regional', 'saudi_arabia', 'press_release', 'tier_3', '2024-08-15', 'medium', 'medium', 'sovereign_alignment', 5,
    ...
    { source_name: 'Humain launch (KSA sovereign AI)', applicability: 'KSA sovereign AI flagship', caveat: 'Capital deployment phased' }),
  D('qia_brookfield_2024', 'qia', 'sovereign_regional', 'qatar', 'partnership_announcement', 'tier_2', '2024-05-01', 'high', 'low', 'partnership_structure', 5,
    ...
    { source_name: 'QIA-Brookfield $20B AI partnership', applicability: 'Native Qatar sovereign deal comp' }),
  ...
  D('brookfield_hyperion_jv_2025', 'brookfield', 'infra_economics', 'us', 'press_release', 'tier_3', '2025-10-01', 'high', 'low', 'partnership_structure', 5,
    ...
    { source_name: 'Meta-Blue Owl Hyperion JV announcement Oct 2025', applicability: 'Largest disclosed AI-anchor DC JV; reference comp for sovereign+operator' }),
  ...
  // ─── Sovereign comparables — strategic compute ───────────────────
