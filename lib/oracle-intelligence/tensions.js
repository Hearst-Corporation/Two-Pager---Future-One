...
const DECISION_TENSIONS = [
  {
    ...
    signals_pushing_a: [
      ...
      'Government demand outpacing supply — political pressure to deploy',
    ],
    signals_pushing_b: [
      'Financial services / government workload requiring SLA',
  ...
  },
  {
    ...
    label: 'Government control vs hyperscaler partnership dependence',
    pole_a: { name: 'Government control', description: 'National-owned compute, domestic procurement, locally-controlled keys' },
    ...
    real_world_examples: [
      'G42 + Microsoft $1.5B (2024) : pole B with government envelope',
  ...
  },
  {
    ...
    real_world_examples: [
      ...
      'Khazna : balanced — government backstop reduces downside',
    ],
  },
  {
  ...
  },
  {
    ...
    signals_pushing_a: [
      ...
      'Government mandate for domestic compute',
    ],
    signals_pushing_b: [
  ...
  },
  {
    ...
    pole_a: { name: 'Vertical integration', description: 'Operator + utility + government + tenant in same vehicle (Khazna model)' },
    pole_b: { name: 'Multi-operator optionality', description: 'Open ecosystem across Equinix, NTT, Vantage, etc. — flexibility, no lock-in' },
    signals_pushing_a: [
      'Government mandate for national champion',
