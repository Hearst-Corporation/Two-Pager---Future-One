...
export const REALITY_CONSTRAINTS = {
  ...
  utility_grid_50mw_approval: {
    ...
    mitigation: 'Utility MOU early ; phased connection 25MW → 50MW ; sovereign acceleration where available',
    breaks_timeline_below_months: 18,
  },
  permit_free_zone: {
    label: 'Permit cycle (free zone / sovereign expedited)',
    benchmark_months: 7,
    range_months: [4, 12],
    constraint_type: 'regulatory',
    severity: 'low',
  ...
  procurement_anchor_contract: {
    ...
    severity: 'high',
    mitigation: 'Strong commercial term sheet ; tenant credit underwriting; sovereign anchor commitment',
  },
