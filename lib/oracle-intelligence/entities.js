...
export const ENTITIES = [
  ...
  },
  {
    ...
    commercial_model: ['wholesale_colo', 'hyperscale_lease'],
    sovereign_alignment: 'commercial',
    strategic_notes: { moat: 'EU sovereign-cloud aligned; Brookfield-owned', monetization: 'Hyperscale + EU sovereign workload' },
  },
  {
    ...
    strategic_notes: { moat: 'UAE national champion; G42 / Microsoft-aligned compute', monetization: 'UAE sovereign + hyperscale' },
  },
  ...
  },
  {
    ...
    commercial_model: ['gpu_cloud', 'ai_training_cluster'],
    sovereign_alignment: 'commercial',
    strategic_notes: { moat: 'EU sovereign GPU cloud; Finland + Israel campus', monetization: '$/GPU-hour + reserved' },
  },
  {
  ...
  },
  {
    ...
    strategic_notes: {
      ...
      monetization: 'Sovereign + industrial anchor tenants',
      energy: 'Renewable-anchored (solar + green H2)',
    },
  },
  {
    id: 'humain_ksa', name: 'Humain (KSA sovereign AI)', category: 'sovereign_regional',
    ticker: 'sovereign (PIF subsidiary)', headquarters: 'KSA',
    commercial_model: ['sovereign_ai'],
    sovereign_alignment: 'sovereign',
    strategic_notes: { moat: 'Saudi national AI venture launched 2024; NSDA-aligned', monetization: 'Sovereign compute + commercial channel TBD' },
  },
  {
    id: 'qia', name: 'Qatar Investment Authority', category: 'sovereign_regional',
    ticker: 'sovereign (Qatar SWF)', headquarters: 'Qatar',
  ...
  },
  {
    ...
    ticker: 'sovereign (Qatar)', headquarters: 'Qatar',
  ...
  },
  {
    ...
    ticker: 'sovereign (KSA)', headquarters: 'KSA',
