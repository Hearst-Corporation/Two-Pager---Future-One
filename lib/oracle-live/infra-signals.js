 ...
 */
export function computeImpactScore(signal, { region, archetype_id } = {}) {
 ...
 */
export function rankSignalsByImpact(signals, ctx = {}) {
  return signals
 ...
 * sorted by computed impact_score descending.
 *
 * @param {object} [opts]
