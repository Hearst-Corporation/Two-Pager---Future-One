...
export function statusBadgeTone(status) {
  ...
  // Mapping aligns with --cp-status-* tokens (source: cp-tokens.css).
  const tones = {
    LIVE: {
      color_token:  'var(--cp-status-success)',
      bg_token:     'var(--cp-status-success-soft)',
      border_token: 'var(--cp-status-success-border)',
      label:        'Live',
    },
    RECENT: {
    ...
    STALE: {
      color_token:  'var(--cp-status-warning)',
      bg_token:     'var(--cp-status-warning-soft)',
      border_token: 'var(--cp-status-warning-border)',
      label:        'Stale',
    },
    DEGRADED: {
      color_token:  'var(--cp-status-danger)',
      bg_token:     'var(--cp-status-danger-soft)',
      border_token: 'var(--cp-status-danger-border)',
      label:        'Degraded',
    },
    UNAVAILABLE: {
