...
// ────────────────────────────────────────────────────────
// Tax defaults — Qatar disposition / corporate (June 2026)
// ────────────────────────────────────────────────────────
// A3: exit capital-gains tax on a hold-then-sell archetype. Qatar levies a 10%
// capital-gains tax on the disposition gain (terminal value − undepreciated book
// value) under Law No. 24 of 2018 (Income Tax Law). Exemptable under QFZA Free
// Zone status with conditions, but defaulted ON here (conservative). Applied to
// POST-tax equity cash flows only — pre-tax flows keep gross treatment.
// Convention: *_pct stored as 0..100 (divided by /100 at each consumption site).
export const TAX_DEFAULTS = {
  capital_gains_rate_pct: 10,   // Qatar capital-gains tax on disposition gain (Law 24/2018)
};
