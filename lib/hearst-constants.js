...
export const BUSINESS_MODELS = [
  ...
  { id: 'sovereign_ai',     label: 'Sovereign AI Cloud',                price_key: 'price_hyperscale_kw_month',    margin_range: [0.50, 0.70] },
  ...
  { id: 'government',       label: 'Government / Defense / Sovereign',  price_key: 'price_hyperscale_kw_month',    margin_range: [0.45, 0.65] },
...
export const OPERATORS = [
  // Core DC operators
  { id: 'equinix',         name: 'Equinix',                        type: 'operator',    region: 'Global',       color: '#C41B1B' },
  { id: 'digital_realty',  name: 'Digital Realty',                 type: 'operator',    region: 'Global',       color: '#0057A8' },
  { id: 'ntt',             name: 'NTT Global DC',                  type: 'operator',    region: 'Global',       color: '#009FDB' },
  { id: 'vantage',         name: 'Vantage Data Centers',           type: 'operator',    region: 'Americas/EMEA',color: '#6B3FA0' },
  { id: 'coreweave',       name: 'CoreWeave',                      type: 'operator',    region: 'US/EU',        color: '#E05A1A' },
  { id: 'lambda',          name: 'Lambda Labs',                    type: 'operator',    region: 'US',           color: '#4F5BD5' },
  // Hyperscalers
  { id: 'aws',             name: 'Amazon AWS',                     type: 'hyperscaler', region: 'Global',       color: '#FF9900' },
  { id: 'microsoft',       name: 'Microsoft Azure',                type: 'hyperscaler', region: 'Global',       color: '#00A4EF' },
  { id: 'google',          name: 'Google Cloud',                   type: 'hyperscaler', region: 'Global',       color: '#4285F4' },
  { id: 'meta',            name: 'Meta',                           type: 'hyperscaler', region: 'Global',       color: '#1877F2' },
  { id: 'oracle',          name: 'Oracle Cloud',                   type: 'hyperscaler', region: 'Global',       color: '#C74634' },
  { id: 'nvidia',          name: 'NVIDIA',                         type: 'hyperscaler', region: 'Global',       color: '#76B900' },
  // Investors
  { id: 'brookfield',      name: 'Brookfield Infrastructure',      type: 'investor',    region: 'Global',       color: '#2E7D32' },
  { id: 'qia',             name: 'QIA',                            type: 'investor',    region: 'Qatar',        color: '#8B1C1C' },
  { id: 'qai',             name: 'Qai',                            type: 'investor',    region: 'Qatar',        color: '#9C5A1D' },
  // Brokers / Advisory
  { id: 'cbre',            name: 'CBRE',                           type: 'broker',      region: 'Global',       color: '#005B41' },
  { id: 'jll',             name: 'JLL',                            type: 'broker',      region: 'Global',       color: '#C41230' },
  { id: 'turner_townsend', name: 'Turner & Townsend',              type: 'broker',      region: 'Global',       color: '#C89A00' },
  { id: 'cushman',         name: 'Cushman & Wakefield',            type: 'broker',      region: 'Global',       color: '#7B0000' },
  // Regulators
  { id: 'kahramaa',        name: 'KAHRAMAA',                       type: 'regulator',   region: 'Qatar',        color: '#006341' },
  { id: 'cra',             name: 'CRA Qatar',                      type: 'regulator',   region: 'Qatar',        color: '#003087' },
  { id: 'moct',            name: 'MoCT Qatar',                     type: 'regulator',   region: 'Qatar',        color: '#5C0000' },
  // Telcos
  { id: 'ooredoo',         name: 'Ooredoo',                        type: 'telco',       region: 'Qatar/MENA',  color: '#C8003C' },
  { id: 'vodafone_qatar',  name: 'Vodafone Qatar',                  type: 'telco',       region: 'Qatar',        color: '#BF0000' },
  // Legal
  { id: 'mayer_brown',     name: 'Mayer Brown',                    type: 'legal',       region: 'Global',       color: '#003B5C' },
  { id: 'baker_mckenzie',  name: 'Baker McKenzie',                  type: 'legal',       region: 'Global',       color: '#1C3A6B' },
  // Standards
  { id: 'uptime',          name: 'Uptime Institute',               type: 'standards',   region: 'Global',       color: '#555555' },
  { id: 'sec',             name: 'SEC (US)',                        type: 'standards',   region: 'US',           color: '#1A3560' },
];
...
export const PUBLIC_SOURCES_LIBRARY = [
  // ── Equinix ─────────────────────────────────────────
  {
    ...
    applicability_to_qatar: 'Global benchmark. Qatar premium of +10-15% expected given scarcity and sovereign demand.',
  ...
  },
  {
    ...
    applicability_to_qatar: 'Qatar sovereign/hyperscale deals likely 12-20 years given strategic nature of investments.',
  ...
  },
  {
    ...
    applicability_to_qatar: 'Qatar positioning as Sovereign AI hub directly addresses this demand. Strong alignment.',
  ...
  // ── Vantage ──────────────────────────────────────────
  {
    ...
    caveat: 'Long-term leases typically require investment-grade tenant credit or sovereign backing.',
  },
  {
  ...
  // ── JLL ───────────────────────────────────────────────
  {
    ...
    quoted_excerpt: 'Qatar data center pricing carries a 10-15% premium to Dubai due to sovereign demand and undersupply.',
  ...
  // ── QIA ───────────────────────────────────────────────
  {
    ...
    metric_id: 'equity_irr_target', metric_name: 'Equity IRR Target (Sovereign)',
    ...
    quoted_excerpt: 'QIA infrastructure investments target 10-14% equity IRR; sovereign AI projects strategic priority.',
    applicability_to_qatar: 'QIA equity tranche may accept lower IRR (10-12%) given strategic value to Qatar 2030 Vision.',
    caveat: 'QIA terms not publicly disclosed. Inferred from QIA mandate and comparable sovereign fund benchmarks.',
  },
  {
