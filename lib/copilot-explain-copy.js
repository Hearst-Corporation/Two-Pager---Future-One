...
export const EXPLAIN_COPY = {
  ...
  total_mw: {
    ...
    detail: 'Deliverable computing power to tenants (excludes PUE overhead). < 20 MW limits margins due to fixed costs. 50–100 MW aligns with hyperscale shells. 300+ MW requires government-scale campus.',
    unit: 'MW',
  ...
  sovereign_ai: {
    short: 'Government AI · Government Anchor.',
