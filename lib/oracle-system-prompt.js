...
export function buildOracleSystemPrompt(ctx = {}) {
  ...
  for (const [, sm] of Object.entries(C.scoring_models)) {
...
export const EXAMPLE_OUTPUTS = {
  stakeholder_adaptation_demo: {
    ...
    sovereign_response_emphasis: [
      'Strategic Context — alignment with QNV 2030 + Brookfield/QIA $20B partnership ; government compute posture vs UAE/G42',
  ...
  region_adaptation_demo: {
    ...
    uae_lens: 'Comparable shell, lower contingency (mature ecosystem), but include G42-tier security overlay if government workload.',
