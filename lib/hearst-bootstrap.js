...
// Dérivation médiane opaque depuis PUBLIC_SOURCES_LIBRARY. Le futur modèle prend ses inputs
// directement du HTML canonique (lib/investment-model/assumptions/). Voir docs/investment-model-migration.md.
//
