...
export const T = {
  all:        `all ${DUR.base} ease`,
  allFast:    `all ${DUR.fast} ease`,
  color:      `color ${DUR.fast} ease`,
  colorBg:    `color ${DUR.fast} ease, background ${DUR.fast} ease`,
  colorBorder:`color ${DUR.fast} ease, border-color ${DUR.fast} ease`,
  bg:         `background ${DUR.base} ease`,
  border:     `border-color ${DUR.base} ease`,
  bgBorder:   `border-color ${DUR.base} ease, background ${DUR.base} ease`,
  bgBorderColor: `background ${DUR.base} ease, border-color ${DUR.base} ease, color ${DUR.base} ease`,
  opacity:    `opacity ${DUR.slow} ease`,
  transform:  `transform ${DUR.drawer} cubic-bezier(0.32, 0.72, 0, 1)`,
  transformBg:     `transform ${DUR.fast} ease, background ${DUR.fast} ease`,
  transformShadow: `transform ${DUR.slow} ease, box-shadow ${DUR.slow} ease`,
  slaBar:          `width 1s linear, background ${DUR.slow} ease`,
};
