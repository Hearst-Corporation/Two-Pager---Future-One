...
export const T = {
  ...
  // Titre de section hero (H2 visuel — aligné sur le canon page H1 24px/800)
  sectionTitle: {
    margin: 0,
    fontSize: 'var(--cp-font-2xl)',
    fontWeight: 'var(--cp-weight-black)',
  ...
  // Valeur de métrique chiffrée (KPI, résultat) — canon KpiCard 24px/700
  metricValue: {
    fontSize: 'var(--cp-font-2xl)',
    fontWeight: 'var(--cp-weight-bold)',
    lineHeight: 1,
...
export const S = {
  ...
  // Section colonne (Card as="section" — TechnologyStackStep, etc.)
  sectionColumn: {
    display: 'flex',
    flexDirection: 'column',
    gap: 'var(--cp-space-4)',
...
export const L = {
  ...
  // Grille 2 colonnes minmax(0,1fr) — cartes interactives (ArchetypePicker, etc.)
  grid2Min: {
    display: 'grid',
