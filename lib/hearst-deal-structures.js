...
// 8 archétypes à scaling factors non sourcés. Le modèle canonique du HTML Qatar n'utilise
// que des scénarios bear/base/bull. Remplacement prévu par lib/investment-model/scenarios/.
// Voir docs/investment-model-migration.md. NE PAS étendre.
//
...
export const PRIMARY_DEAL_ARCHETYPES = DEAL_ARCHETYPES.filter((a) =>
  PRIMARY_MODEL_IDS.includes(a.id),
);
