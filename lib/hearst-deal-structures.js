...
import { FINANCIAL_THRESHOLDS, MINORITY_EQUITY_SHARE_DEFAULT } from './hearst-constants';
...
export const DEAL_ARCHETYPES = [
  ...
  },
  {
    ...
    equity_share: MINORITY_EQUITY_SHARE_DEFAULT,
  ...
  if (archetype.compute_as === 'minority_equity') {
    ...
    return {
      ...
      projection: {
        ...
        equity_share: archetype.equity_share || MINORITY_EQUITY_SHARE_DEFAULT,
