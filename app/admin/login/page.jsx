...
const S = {
  ...
  eyebrow: { fontSize: 11, letterSpacing: 3, fontWeight: 800, color: 'var(--color-login-accent)' },
  title: { fontSize: 28, fontWeight: 800, letterSpacing: -1, margin: 0, color: 'var(--color-login-text)' },
  sub: { fontSize: 13, margin: 0, color: 'var(--color-login-text-muted)' },
  input: {
    padding: '12px 14px',
