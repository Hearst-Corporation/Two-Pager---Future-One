...
// resolveTruthProjection / compactLiveBriefForModel live in a sibling module:
// route.js may only export route handlers/config, never plain functions.
import { resolveTruthProjection, compactLiveBriefForModel } from './memo-projection';
