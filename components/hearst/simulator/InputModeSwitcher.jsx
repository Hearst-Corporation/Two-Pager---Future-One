...
const S = {
  ...
  iconBadge: {
    ...
    borderRightColor: 'var(--cp-border)',
    borderBottomColor: 'var(--cp-border)',
    borderLeftColor: 'var(--cp-border)',
    background: 'var(--cp-surface-1)',
    color: 'var(--cp-text-muted)',
    flexShrink: 0,
  },
  iconBadgeActive: {
    borderTopColor: 'var(--cp-border-strong)',
    borderRightColor: 'var(--cp-border-strong)',
    borderBottomColor: 'var(--cp-border-strong)',
    borderLeftColor: 'var(--cp-border-strong)',
