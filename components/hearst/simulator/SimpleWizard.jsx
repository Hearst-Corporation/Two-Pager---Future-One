...
const S = {
  ...
  cardGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: 12 },
  dealCard: {
    position: 'relative',
  ...
  dealIcon: { fontSize: 28, lineHeight: 1 },
  dealTitle: { fontSize: 16, fontWeight: 800, color: 'var(--cp-text-primary)' },
  dealPitch: { fontSize: 13, color: 'var(--cp-text-body)', lineHeight: 1.5 },
  dealPros: { fontSize: 12, color: 'var(--cp-text-muted)', lineHeight: 1.5, marginTop: 'auto' },
  dealRecommended: {
    position: 'absolute', top: 8, right: 8,
    fontSize: 9, fontWeight: 800, padding: '4px 8px',
    background: 'var(--cp-accent)', color: 'var(--cp-text-strong)',
    borderRadius: 999, letterSpacing: 0.5,
  },

  mixBar: { display: 'flex', height: 10, background: 'var(--cp-border)', borderRadius: 999, overflow: 'hidden', marginTop: 8 },
  mixSeg: { display: 'inline-block' },
  mixLegend: { fontSize: 11, color: 'var(--cp-text-muted)', fontFamily: 'ui-monospace, monospace' },

  story: { display: 'flex', flexDirection: 'column', gap: 12 },
  storyLine: { fontSize: 16, lineHeight: 1.6, color: 'var(--cp-text-body)', margin: 0 },

  kpiGrid: { display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: 8, marginTop: 16 },
  kpi: { padding: 16, background: 'var(--cp-surface-0)', border: '1px solid var(--cp-border)', borderRadius: 10 },
  kpiLabel: { fontSize: 10, fontWeight: 700, color: 'var(--cp-text-muted)', textTransform: 'uppercase', letterSpacing: 0.5 },
  kpiValue: { fontSize: 20, fontWeight: 800, color: 'var(--cp-text-primary)', marginTop: 4, fontVariantNumeric: 'tabular-nums' },

  navRow: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 12, marginTop: 16 },
  btnGhost: {
  ...
  btnPrimary: {
    ...
    fontSize: 14, fontWeight: 800, cursor: 'pointer', letterSpacing: 0.3,
  },
};
