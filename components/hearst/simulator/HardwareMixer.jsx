...
import { HARDWARE_PRESETS as HW_PRESET_PATCHES } from '@/lib/hearst-config-presets';
...
const PRESET_LABELS = {
  colo: { name: UI.HW_PRESET_COLO_NAME, tagline: UI.HW_PRESET_COLO_TAGLINE, info: UI.HW_PRESET_COLO_INFO },
  mixed: { name: UI.HW_PRESET_MIXED_NAME, tagline: UI.HW_PRESET_MIXED_TAGLINE, info: UI.HW_PRESET_MIXED_INFO },
  ai_factory: { name: UI.HW_PRESET_AI_NAME, tagline: UI.HW_PRESET_AI_TAGLINE, info: UI.HW_PRESET_AI_INFO },
};
