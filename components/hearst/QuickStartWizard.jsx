...
const S = {
  ...
  eyebrow: {
    ...
    color: 'var(--color-accent-strong)', textTransform: 'uppercase', marginBottom: 4,
  },
  title: { fontSize: 18, fontWeight: 800, color: 'var(--color-text-primary)' },
  closeBtn: {
  ...
  progress: {
    height: 3, background: 'var(--color-border-light)', margin: '0 24px 18px',
  },
  progressFill: {
    height: '100%', background: 'var(--color-accent-strong)', transition: 'width .25s ease',
  },
  body: { padding: '0 24px 12px' },
  question: { fontSize: 14, fontWeight: 600, color: 'var(--color-text-primary)', marginBottom: 6, lineHeight: 1.5 },
  note: { fontSize: 12, color: 'var(--color-text-muted)', marginBottom: 18, lineHeight: 1.55 },
  inputWrap: { display: 'flex', alignItems: 'center', gap: 8 },
  input: {
    flex: 1, fontSize: 16, fontWeight: 600,
    padding: '10px 14px',
    border: '2px solid var(--color-border-light)', borderRadius: 8,
  ...
  error: {
    ...
    background: 'var(--color-bg-secondary)', padding: '8px 12px', borderRadius: 6, marginTop: 12,
  },
  footer: {
